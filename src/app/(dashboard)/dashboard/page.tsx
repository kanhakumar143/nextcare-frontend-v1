      ...
      <CardContent className="space-y-4 text-sm">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold">117 <span className="text-muted-foreground text-base">bpm</span></p>
          </div>
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="text-muted-foreground text-sm">Cholesterol Level</p>
            <p className="text-2xl font-bold">156 <span className="text-muted-foreground text-base">mg</span></p>
          </div>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold">124 <span className="text-muted-foreground text-base">ml</span></p>
          </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="text-sm">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-green-600 text-sm">You are Healthy</span>
              </div>
      ...
      <Card className="col-span-1 ">
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm font-medium text-green-600">May 2025</div>
          </div>
        </CardHeader>
        <CardContent>
          <Calendar
          ...
          <div className="pt-4 space-y-2 text-sm">
            <div className="border-l-4 border-amber-400 pl-3">
              <p className="font-medium text-green-600">8:30 AM - 9:00 AM</p>
            ...
            <div className="border-l-4 border-green-400 pl-3">
              <p className="font-medium text-green-600">9:00 AM - 9:30 AM</p>
            ...
            <div className="border-l-4 border-red-400 pl-3">
              <p className="font-medium text-green-600">11:00 AM - 11:30 AM</p>
      ...
      <Card className="col-span-4 self-start">
        ...
        <CardContent>
          ...
          <div className="flex items-center gap-2">
            <div className="w-4 h-1.5 rounded bg-[#5B9EFF]" />
            <span className="text-sm text-muted-foreground">Water</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-4 h-1.5 rounded bg-[#FF8E8E]" />
            <span className="text-sm text-muted-foreground">Steps</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-4 h-1.5 rounded bg-[#FFD06B]" />
